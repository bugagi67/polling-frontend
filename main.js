...
.wrapper-message div:not(:last-child) {
    margin-right: 20px;
}
...
.error-message {
    color: #58a94a;
}`, "",{"version":3,"sources":["webpack://./src/css/style.css"],"names":[],"mappings":"AAAA;IACI,UAAU;IACV,SAAS;IACT,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,iBAAiB;IACjB,mBAAmB;IACnB,iBAAiB;IACjB,iBAAiB;AACrB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,uBAAuB;IACvB,kBAAkB;IAClB,8BAA8B;AAClC;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,YAAY;IACZ,mBAAmB;IACnB,iBAAiB;AACrB;;AAEA;IACI,cAAc;AAClB","sourcesContent":["* {\n    padding: 0;\n    margin: 0;\n    box-sizing: border-box;\n}\n\n.container {\n    display: flex;\n    flex-direction: column;\n    text-align: start;\n    align-items: center;\n    text-align: start;\n    margin-top: 100px;\n}\n\n.wrapper-message {\n    width: 540px;\n    display: flex;\n    border: 1px solid black;\n    padding: 10px 20px;\n    justify-content: space-between;\n}\n\n.wrapper-message div:not(:last-child) {\n    margin-right: 20px;\n}\n\n.title-error {\n    display: flex;\n    justify-content: space-between;\n    width: 540px;\n    align-items: center;\n    padding: 5px 10px;\n}\n\n.error-message {\n    color: #58a94a;\n}"],"sourceRoot":""}]);
// Exports
...
var Messages = /*#__PURE__*/function () {
  ...
  return _createClass(Messages, [{
    key: "createElementMessage",
    value: function createElementMessage(email, subject, date) {
      var wrapperMessage = document.createElement("div");
      wrapperMessage.className = "wrapper-message";
      wrapperMessage.innerHTML = "\n        <div class=\"email\">".concat(email.length > 15 ? email.substring(0, 15) + "..." : email, "</div>\n        <div class=\"subject\">").concat(subject.length > 15 ? subject.substring(0, 15) + "..." : subject, "</div>\n        <div class=\"date\">").concat(date, "</div>\n        ");
      this.wrapper.insertAdjacentElement("afterbegin", wrapperMessage);
    }
  }, {
    key: "resetList",
    value: function resetList() {
      var arrayElement = document.querySelectorAll(".wrapper-message");
...
var unreadMessage = [];
var pollingInterval$ = interval(10000);
pollingInterval$.pipe(mergeMap(function () {
  return ajax.getJSON("https://poling-backend.onrender.com/messages/unread").pipe(map(function (response) {
  ...
  next: function next(event) {
    var existingIds = new Set(unreadMessage.map(function (item) {
      return item.id;
    }));
    var arrayMessage = event.messages;
    var newMessages = arrayMessage.filter(function (item) {
      return !existingIds.has(item.id);
    });
    if (newMessages.length === 0) {
      messages.showError("Нет новых непрочитанных");
      setTimeout(function () {
        return messages.clearError();
      }, 4000);
    }
  ...
  error: function error(_error) {
    console.error("Необработанная ошибка: ", _error);
  }
});
;// ./src/index.js
